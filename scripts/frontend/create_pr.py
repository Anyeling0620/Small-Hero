...
def create_pr():
    ...
    try:
        ...
        branch_name = f"feature/frontend-issue-{issue_number}"
        
        print(f"🔄 为 Issue #{issue_number} 创建 PR")
        
        # 创建 PR
        pr_title = f"[Frontend] {issue.title}"
        pr_body = f"""
## 相关 Issue
Closes #{issue_number}

## 变更说明
自动生成的前端代码，实现了 Issue 中描述的功能。
